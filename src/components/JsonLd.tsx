...
export function businessJsonLd() {
  return {
    ...
    url: SITE_URL,
    description:
      "Coach Deising's youth pitching lessons in Naples, FL for players ages 8-16. He's the head coach, and he works with parents, coaches, travel teams, and schools.",
