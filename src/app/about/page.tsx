...
export default function AboutPage() {
  return (
    <article className="about-stadium relative isolate overflow-hidden">
      <div className="about-stadium-media" aria-hidden="true">
        <Image
          src="/assets/pixel-stadium-bg-v2.png"
          alt=""
          fill
          className="about-stadium-bg"
          sizes="100vw"
          priority
        />
        <div className="about-stadium-wash" />
      </div>
        ...
        <Reveal className="space-y-6">
          ...
          <div className="grid items-start gap-8 sm:grid-cols-[minmax(0,14rem)_1fr]">
            <Image
              ...
              priority
            />
            <div className="about-stadium-copy space-y-4 text-base leading-relaxed text-ink-soft">
