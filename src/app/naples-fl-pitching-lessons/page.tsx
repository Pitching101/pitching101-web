...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Coach Nick helps kids ages 8-14 throw more strikes in Naples and SWFL. Families, travel teams, other coaches, and schools.",
    type: "website",
  },
};
...
const whoFor = [
  ...
  "Families, travel teams, other coaches, and schools",
