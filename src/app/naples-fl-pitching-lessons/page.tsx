...
export default function NaplesPitchingLessonsPage() {
  return (
    <article className="arcade-hero-band mx-auto max-w-3xl px-5 py-12 sm:px-8 sm:py-16">
      <p className="font-pixel-ui text-lg font-semibold text-blue-light">
      ...
      <div className="mt-6 inline-flex">
        <span className="pixel-icon-frame pixel-ball-bob p-1" aria-hidden="true">
          <PixelBall size={36} />
        </span>
      </div>
      ...
      <h1 className="pixel-title pixel-title-lg mt-5">
        Youth pitching lessons Naples FL — insert coin, get better
      </h1>
        ...
        <section className="mt-12 space-y-4">
          ...
          <ul className="space-y-3 text-ink-soft">
            <li className="flex gap-3">
              <span className="mt-1 text-yellow" aria-hidden="true">
                ■
              </span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="mt-1 text-green-bright" aria-hidden="true">
                ■
              </span>
              <span>
      ...
      <Reveal>
        <section className="pixel-card mt-12 p-7 sm:p-9">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link
              href="/#programs"
              className="font-pixel-ui px-2 py-2.5 text-lg font-semibold text-yellow underline-offset-4 hover:underline"
            >
              See program paths →
            </Link>
          </div>
