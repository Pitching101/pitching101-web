...
export const metadata: Metadata = {
  ...
  description:
    "Free pitching guides for players 8–16 in Naples: how to choose lessons, arm care, strike tips, a pre-catch warmup, and fun command games. Same stuff I use in lessons.",
  alternates: { canonical: "/guides/" },
  openGraph: {
    title: pageTitle("Free youth pitching guides"),
    description:
      "Free pitching guides for ages 8–16 in Naples, FL: arm-care checklist, strike tips, a pre-catch warmup, and fun command games.",
    url: "/guides/",
