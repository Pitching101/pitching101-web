...
export default function HomePage() {
  return (
    <ParkSky tone="park" clouds={14}>
      <JsonLd data={businessJsonLd()} />
      <JsonLd data={faqJsonLd(faqs)} />

      <article className="park-page park-page-home">
        <section className="park-home-hero" aria-label="Youth pitching lessons in Naples, FL">
        ...
        <section className="park-home-block" id="reviews" aria-label="What parents say">
        ...
        <section
          id="about"
          className="park-home-block scroll-mt-24"
